...
**Currently, eight apps are live on the App Store: Luxira (QR & Barcode Scanner), Sincefy (countdown widget), Sopora (sleep journal), logfd (food & intake diary), BPIVY (blood-pressure log), Raheva (period tracker), Postivo (intermittent-fasting timer, live since 2026-08-18), and Esynit (PDF signing, live since 2026-08-21). Balanza (BMI & weight tracker) and Skanvo (document/PDF scanner) are public coming-soon apps.** The homepage spotlights Sincefy and shows all eight live apps as `AppCard`s plus 1 `PlaceholderCard` hinting at "more coming soon" (Balanza is not in the hardcoded grid yet). Future apps beyond these nine remain confidential — names, categories, and details must NOT appear on the site until they ship.
