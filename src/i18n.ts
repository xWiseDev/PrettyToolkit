...
export const ui = {
  en: {
    ...
    support: {
      ...
      contactCopy: 'For questions, feedback, or issues, email us at',
      ...
      faqs: [
        ...
        ["The app isn't working correctly. What should I do?", "Try closing and reopening the app, or restarting your device. Make sure you're running the latest version from the App Store. If the issue persists, contact us at aboyahyadev@icloud.com with a description of the problem."],
  ...
  fr: {
    ...
    support: {
      ...
      contactCopy: 'Pour une question, un retour ou un probleme, ecrivez-nous a',
  ...
  es: {
    ...
    support: {
      ...
      contactCopy: 'Para preguntas, comentarios o problemas, escribenos a',
  ...
  de: {
    ...
    support: {
      ...
      contactCopy: 'Bei Fragen, Feedback oder Problemen schreib uns an',
