...
- `src/pages/[slug]/index.astro` builds app landing pages with the hero, direct-answer block, capabilities block, features, screenshots, FAQ, download CTA, cross-promo, and app-page structured data.
